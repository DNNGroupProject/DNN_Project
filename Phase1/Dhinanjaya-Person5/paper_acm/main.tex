...
information from stages 1--3. A small diagnostic ($n{=}3$ images, raw
per-stage attention averaged into an $8{\times}8$ grid --- spatial
reduction leaves every stage's key/value count at 64) finds stages 1--3
correlate weakly with the ground-truth mask (mean $r{=}0.20$--$0.31$) versus
stage 4's $r{=}0.55$, suggesting less mask-relevant signal to begin with
rather than a large loss, though $n{=}3$ is too small to be conclusive.
