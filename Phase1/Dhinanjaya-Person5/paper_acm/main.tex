...
(0.8017$\to$0.8191) and IoU (0.6690$\to$0.6936), alongside a full-scale-trained U-Net baseline
(Dice 0.8615, IoU 0.7568). Full-scale validation and a complete ablation
study are ongoing.
\end{abstract}
...
\begin{table}[t]
\caption{Preliminary comparison. SegFormer variants: 400/60/60-image,
8-epoch CPU smoke run. DeepLabV3+: 200-image smoke run, optional extra
baseline. U-Net: full-scale (5{,}108-image, 20-epoch, 3576/766/766 split,
seed 42) PyTorch checkpoint, the same split/seed/training loop as the
SegFormer runs.}
\label{tab:results}
