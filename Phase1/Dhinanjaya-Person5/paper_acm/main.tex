...
\textbf{Dataset.} 5{,}000 RGB aerial images ($256{\times}256$) with binary
forest/non-forest masks; 70/15/15 stratified train/val/test split.
...
cost segmentation accuracy at this scale.

\begin{table}[t]
\caption{Preliminary comparison (CPU smoke run, 400/60/60 images, 8 epochs).}
\label{tab:results}
...
a reliable trend; the full 5{,}000-image, 20-epoch run is pending.
